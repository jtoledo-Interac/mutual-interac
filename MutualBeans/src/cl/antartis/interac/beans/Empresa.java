...
public class Empresa implements Serializable {
	...
	public String getAnoDeAdhesion() {
		return anoDeAdhesion;
	}
	public void setAnoDeAdhesion(String anoDeAdhesion) {
		this.anoDeAdhesion = anoDeAdhesion;
	}
	...
	public void setPlanesDeCuenta(String planesDeCuenta) {
		this.planesDeCuenta = planesDeCuenta;
	}
	public String getPlanesDeTrabajo() {
		return planesDeTrabajo;
	}
	public void setPlanesDeTrabajo(String planesDeTrabajo) {
		this.planesDeTrabajo = planesDeTrabajo;
	}
	public String getFirmaDePlanes() {
		return firmaDePlanes;
	}
	public void setFirmaDePlanes(String firmaDePlanes) {
		this.firmaDePlanes = firmaDePlanes;
	}
	public String getSistemaDeGestion() {
	...
	public void setUltimaVisitaAltaGerencia(String ultimaVisitaAltaGerencia) {
		this.ultimaVisitaAltaGerencia = ultimaVisitaAltaGerencia;
	}
	public String getReporteVisita() {
