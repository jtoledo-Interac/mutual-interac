...
public class MutualEJB implements EJBRemoto {
	...
	public Map<String, Object> modificarEmpresa(Map<String, Object> mapaEntrada) {
		...
		try {
			...
			cStmt.setDate(30, Utils.stringToDate(empresa.getUltimaVisitaExperto()));
			cStmt.setDate(31, Utils.stringToDate(empresa.getUltimaVisitaDirector()));
			cStmt.setDate(32, Utils.stringToDate(empresa.getUltimaVisitaGtte()));
			cStmt.setDate(33, Utils.stringToDate(empresa.getUltimaVisitaAltaGerencia()));
			cStmt.setString(34, empresa.getReporteVisita());
			cStmt.setString(35, empresa.getRiesgoDeFuga());
			cStmt.setDate(36, Utils.stringToDate(empresa.getReclamoUltimoPeriodo()));
	...
	public Map<String, Object> agregarEmpresa(Map<String, Object> mapaEntrada) {
		...
		try {
			...
			cStmt.setString(17, empresa.getSistemaDeGestion());
			cStmt.setString(18, empresa.getConstitucionCphs());
			cStmt.setString(19, empresa.getCertificacionCphs());
			cStmt.setString(20, empresa.getMmc());
			cStmt.setString(21, empresa.getTmert());
			cStmt.setString(22, empresa.getPlanesi());
			cStmt.setString(23, empresa.getPlaguicida());
			cStmt.setString(24, empresa.getRadiacionUv());
			cStmt.setString(25, empresa.getHipobaria());
	...
	public Map<String, Object> cargarEmpresa(Map<String, Object> mapaEntrada) {
		...
		try {
			...
			while (rsEmpresa.next()) {
				...
				empresa.setConstitucionCphs(rsEmpresa.getString("constitucion_cphs"));
				empresa.setCertificacionCphs(rsEmpresa.getString("certificacion_cphs"));
				...
				empresa.setProyectoInvestigacion(rsEmpresa.getString("proyecto_investigacion"));
				...
				empresa.setParticipaMesaTrabajo(rsEmpresa.getString("participacion_mesa_trabajo"));
			}
