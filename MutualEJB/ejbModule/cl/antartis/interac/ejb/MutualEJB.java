...
public class MutualEJB implements EJBRemoto {
	...
	public Map<String, Object> modificarEmpresa(Map<String, Object> mapaEntrada) {
		...
		try {
			...
			cStmt.setString(9, empresa.getHolding());
			cStmt.setString(10,empresa.getEstrategica());
			cStmt.setString(11, empresa.getSituacion());
			cStmt.setString(12, empresa.getMultiregion());
			cStmt.setString(13, empresa.getCasaMatriz());			
			cStmt.setString(14, empresa.getNumCentrosTrabajo());
			cStmt.setString(15, empresa.getMasaSumMetropolitana());
			cStmt.setString(16, empresa.getMasaSumNacional());
			cStmt.setString(17, empresa.getPlanesDeCuenta());
			cStmt.setString(18, empresa.getPlanesDeTrabajo());
			cStmt.setString(19, empresa.getFirmaDePlanes());
			cStmt.setString(20, empresa.getSistemaDeGestion());
			cStmt.setString(21, empresa.getEtapaSistemaGestion());
			cStmt.setDate(22,Utils.stringToDate(empresa.getFirmaProtocolo()));
			cStmt.setString(23, empresa.getNumCphs());
			cStmt.setString(24, empresa.getNumCphsCertificado());
			cStmt.setString(25, empresa.getNumCphsBronce());
			cStmt.setString(26, empresa.getNumCphsPlata());
			cStmt.setString(27, empresa.getNumCphsOro());
			cStmt.setString(28, empresa.getPrexor());
			cStmt.setString(29, empresa.getPrexorEtapa());
			cStmt.setString(30, empresa.getPrexorTexto());
			cStmt.setString(31, empresa.getPlanesi());
			cStmt.setString(32, empresa.getPlanesiEtapa());
			cStmt.setString(33, empresa.getPlanesiTexto());
			cStmt.setString(34, empresa.getAsbesto());
			cStmt.setString(35, empresa.getAsbestoEtapa());
			cStmt.setString(36, empresa.getAsbestoTexto());
			cStmt.setString(37, empresa.getHipobaria());
			cStmt.setString(38, empresa.getHipobariaEtapa());
			cStmt.setString(39, empresa.getHipobariaTexto());
			cStmt.setString(40, empresa.getRadiaciones());
			cStmt.setString(41, empresa.getRadiacionesEtapa());
			cStmt.setString(42, empresa.getRadiacionesTexto());
			cStmt.setString(43, empresa.getAsma());
			cStmt.setString(44, empresa.getAsmaEtapa());
			cStmt.setString(45, empresa.getAsmaTexto());
			cStmt.setString(46, empresa.getSolventes());
			cStmt.setString(47, empresa.getSolventesEtapa());
			cStmt.setString(48, empresa.getSolventesTexto());
			cStmt.setString(49, empresa.getMetales());
			cStmt.setString(50, empresa.getMetalesEtapa());
			cStmt.setString(51, empresa.getMetalesTexto());
			cStmt.setString(52, empresa.getOxido());
			cStmt.setString(53, empresa.getOxidoEtapa());
			cStmt.setString(54, empresa.getOxidoTexto());
			cStmt.setString(55, empresa.getPlaguicida());
			cStmt.setString(56, empresa.getPlaguicidaEtapa());
			cStmt.setString(57, empresa.getPlaguicidaTexto());
			cStmt.setString(58, empresa.getPsicosociales());
			cStmt.setString(59, empresa.getPsicosocialesEtapa());
			cStmt.setString(60, empresa.getPsicosocialesTexto());
			cStmt.setString(61, empresa.getMmc());
			cStmt.setString(62, empresa.getMmcEtapa());
			cStmt.setString(63, empresa.getMmcTexto());
			cStmt.setString(64, empresa.getTmert());
			cStmt.setString(65, empresa.getTmertEtapa());
			cStmt.setString(66, empresa.getTmertTexto());
			cStmt.setString(67, empresa.getRadiacionUV());
			cStmt.setString(68, empresa.getRadiacionUVEtapa());			
			cStmt.setString(69, empresa.getRadiacionUVTexto());
			cStmt.setDate(70, Utils.stringToDate(empresa.getUltimaVisitaExperto()));			
			cStmt.setDate(71, Utils.stringToDate(empresa.getUltimaVisitaDirector()));
			cStmt.setDate(72, Utils.stringToDate(empresa.getUltimaVisitaGTTE()));
			cStmt.setDate(73, Utils.stringToDate(empresa.getUltimaVisitaAltaGerencia()));
			cStmt.setString(74, empresa.getReporteVisita());
			cStmt.setString(75, empresa.getRiesgoDeFuga());
			cStmt.setDate(76, Utils.stringToDate(empresa.getReclamoUltimoPeriodo()));
			cStmt.setString(77, empresa.getParticipacionMesaTrabajo());
			cStmt.registerOutParameter(78, Types.VARCHAR);// numerror$
			cStmt.registerOutParameter(79, Types.VARCHAR);// msjerror$

	cStmt.execute();

	error.setNumError(cStmt.getString(78));
	error.setMsjError(cStmt.getString(79));
	...
	public Map<String, Object> agregarEmpresa(Map<String, Object> mapaEntrada) {
		...
		try {
			...
			cStmt.setDate(21, Utils.stringToDate(empresa.getFirmaProtocolo()));
			cStmt.setString(22, empresa.getNumCphs());
			cStmt.setString(23, empresa.getNumCphsCertificado());
			cStmt.setString(24, empresa.getNumCphsBronce());
			cStmt.setString(25, empresa.getNumCphsPlata());
			cStmt.setString(26, empresa.getNumCphsOro());
			cStmt.setString(27, empresa.getPrexor());
			cStmt.setString(28, empresa.getPrexorEtapa());
			cStmt.setString(29, empresa.getPrexorTexto());
			cStmt.setString(30, empresa.getPlanesi());
			cStmt.setString(31, empresa.getPlanesiEtapa());
			cStmt.setString(32, empresa.getPlanesiTexto());
			cStmt.setString(33, empresa.getAsbesto());
			cStmt.setString(34, empresa.getAsbestoEtapa());
			cStmt.setString(35, empresa.getAsbestoTexto());
			cStmt.setString(36, empresa.getHipobaria());
			cStmt.setString(37, empresa.getHipobariaEtapa());
			cStmt.setString(38, empresa.getHipobariaTexto());
			cStmt.setString(39, empresa.getRadiaciones());
			cStmt.setString(40, empresa.getRadiacionesEtapa());
			cStmt.setString(41, empresa.getRadiacionesTexto());
			cStmt.setString(42, empresa.getAsma());
			cStmt.setString(43, empresa.getAsmaEtapa());
			cStmt.setString(44, empresa.getAsmaTexto());
			cStmt.setString(45, empresa.getSolventes());
			cStmt.setString(46, empresa.getSolventesEtapa());
			cStmt.setString(47, empresa.getSolventesTexto());
			cStmt.setString(48, empresa.getMetales());
			cStmt.setString(49, empresa.getMetalesEtapa());
			cStmt.setString(50, empresa.getMetalesTexto());
			cStmt.setString(51, empresa.getOxido());
			cStmt.setString(52, empresa.getOxidoEtapa());
			cStmt.setString(53, empresa.getOxidoTexto());
			cStmt.setString(54, empresa.getPlaguicida());
			cStmt.setString(55, empresa.getPlaguicidaEtapa());
			cStmt.setString(56, empresa.getPlaguicidaTexto());
			cStmt.setString(57, empresa.getPsicosociales());
			cStmt.setString(58, empresa.getPsicosocialesEtapa());
			cStmt.setString(59, empresa.getPsicosocialesTexto());
			cStmt.setString(60, empresa.getMmc());
			cStmt.setString(61, empresa.getMmcEtapa());
			cStmt.setString(62, empresa.getMmcTexto());
			cStmt.setString(63, empresa.getTmert());
			cStmt.setString(64, empresa.getTmertEtapa());
			cStmt.setString(65, empresa.getTmertTexto());
			cStmt.setString(66, empresa.getRadiacionUV());
			cStmt.setString(67, empresa.getRadiacionUVEtapa());			
			cStmt.setString(68, empresa.getRadiacionUVTexto());
			cStmt.setDate(69, Utils.stringToDate(empresa.getUltimaVisitaExperto()));			
			cStmt.setDate(70, Utils.stringToDate(empresa.getUltimaVisitaDirector()));
			cStmt.setDate(71, Utils.stringToDate(empresa.getUltimaVisitaGTTE()));
			cStmt.setDate(72, Utils.stringToDate(empresa.getUltimaVisitaAltaGerencia()));
			cStmt.setString(73, empresa.getReporteVisita());
			cStmt.setString(74, empresa.getRiesgoDeFuga());
			cStmt.setDate(75, Utils.stringToDate(empresa.getReclamoUltimoPeriodo()));
			cStmt.setString(76, empresa.getParticipacionMesaTrabajo());
			cStmt.registerOutParameter(77, Types.VARCHAR);// numerror$
			cStmt.registerOutParameter(78, Types.VARCHAR);// msjerror$

			cStmt.execute();

			error.setNumError(cStmt.getString(77));
			error.setMsjError(cStmt.getString(78));
