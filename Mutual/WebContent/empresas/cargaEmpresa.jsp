...
<form id="formEdita" action="Servlet" method="post" onSubmit="return validar_form(this)">
	...
	<table>
		...
		<tr>
			...
			<td><input required type="text"  	value="${empresa.prexorObservaciones}"	id="prexorObservaciones" 	name="prexorObservaciones"	placeholder="Observaciones" ></td>
		</tr>
		<tr>
			<td>PLANESI</td><td> : </td>
			<td>
		...
		<tr>
			...
			<td>
			<select id="planesiEtapa" name="planesiEtapa" required>
				<option value="Evaluación Cualitativa">Evaluación Cualitativa</option>
				<option value="No Aplica">No Aplica</option>
				<option value="Difusión del Protocolo">Difusión del Protocolo</option>
		...
		<tr>
			...
			<td><input required type="text"  value="${empresa.planesiObservaciones}"		id="planesiObservaciones" 	name="planesiObservaciones"	placeholder="Observaciones" ></td>
		</tr>
		<tr>
			<td>Asbesto</td><td> : </td>
			<td>
		...
		<tr>
			...
			<td><input required type="text"  value="${empresa.asbestoObservaciones}"		id="asbestoObservaciones" 	name="asbestoObservaciones"	placeholder="Observaciones" ></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input required type="text"  value="${empresa.hipobariaObservaciones}"		id="hipobariaObservaciones" 	name="hipobariaObservaciones"	placeholder="Observaciones" ></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input required type="text"  value="${empresa.radiacionObservaciones}"		id="radiacionObservaciones" 	name="radiacionObservaciones"	placeholder="Observaciones" ></td>
		</tr>
		<tr>
			<td>Asma</td><td> : </td>
			<td>
		...
		<tr>
			...
			<td><input required type="text"  	value="${empresa.asmaObservaciones}"	id="asmaObservaciones" 	name="asmaObservaciones"	placeholder="Observaciones" ></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input required type="text"  	value="${empresa.solventesObservaciones}"	id="solventesObservaciones" 	name="solventesObservaciones"	placeholder="Observaciones" ></td>
		</tr>
		<tr>
			<td>Metales</td><td> : </td>
			<td>
		...
		<tr>
			...
			<td><input required type="text"  	value="${empresa.metalesObservaciones}"	id="metalesObservaciones" 	name="metalesObservaciones"	placeholder="Observaciones" ></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input required type="text"  	value="${empresa.oxidoObservaciones}"	id="oxidoObservaciones" 	name="oxidoObservaciones"	placeholder="Observaciones" ></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input required type="text"  value="${empresa.plaguicidaObservaciones}"		id="plaguicidaObservaciones" 	name="plaguicidaObservaciones"	placeholder="Observaciones" ></td>
		</tr>
		<tr>
			<td>MMC</td><td> : </td>
			<td>
		...
		<tr>
			...
			<td><input required type="text"  	value="${empresa.mmcObservaciones}"	id="mmcObservaciones" 	name="mmcObservaciones"	placeholder="Observaciones" ></td>
		</tr>
		<tr>
			<td>TMERT</td><td> : </td>
			<td>
		...
		<tr>
			...
			<td><input required type="text"  value="${empresa.tmertObservaciones}"		id="tmertObservaciones" 	name="tmertObservaciones"	placeholder="Observaciones" ></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input required type="text"  	value="${empresa.radiacionUvObservaciones}"	id="radiacionUvObservaciones" 	name="radiacionUvObservaciones"	placeholder="Observaciones" ></td>
		</tr>
		<tr>
