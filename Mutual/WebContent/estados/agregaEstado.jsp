...
<form id="formAgrega" action="Servlet" method="post" onSubmit="return validar_form(this)">
	...
	<input type="text" 		id="desEstado" 	name="desEstado"		placeholder="Nuevo estado" onfocus="this.style.boxShadow='0 0 10px #9ecaed'" onblur="this.style.boxShadow='none'">
	<input type="text" 		id="codEstado" 	name="codEstado"		placeholder="Codigo" maxlength="5" onfocus="this.style.boxShadow='0 0 10px #9ecaed'" onblur="this.style.boxShadow='none'"> 
