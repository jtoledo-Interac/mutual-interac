...
<script type="text/javascript"> 
	...
	$(function() {
		...
		$('#listadoCategorias').jqGrid(
		{
			...
			colModel : [
						...
						{name : 'desCategoria', index:'desCategoria', width : 80, search : true, resizable : false, sortable : true},				
	...
	function editarCategoria(idCategoria)
	{
		...
		ajaxCall(getUrlCargarCategoria(idCategoria), function(response){
	...
	{  
   		jConfirm('¿ Confirma eliminar la Categoria ?', 'Confirmación', function(res){
   			if (res == true){
  				ajaxCall(getUrlEliminarCategoria(idCategoria), function(){
