...
if(error == null) error = new Error();
	...
	public void agregarEmpresa(HttpServletRequest request,
		...
		empresa.setAsbestoEtapa(request.getParameter("asbestoEtapa"));
		empresa.setAsbestoTexto(request.getParameter("asbestoTexto"));
		empresa.setAsma(request.getParameter("asma"));
		empresa.setAsmaEtapa(request.getParameter("asmaEtapa"));
		empresa.setAsmaTexto(request.getParameter("asmaTexto"));
		...
		empresa.setMasaSumMetropolitana(request.getParameter("masaSumMetropolitana"));
		empresa.setMasaSumNacional(request.getParameter("masaSumNacional"));
		empresa.setMetales(request.getParameter("metales"));
		empresa.setMetalesEtapa(request.getParameter("metalesEtapa"));
		empresa.setMetalesTexto(request.getParameter("metalesTexto"));
		empresa.setMmc(request.getParameter("mmc"));
		empresa.setMmcEtapa(request.getParameter("mmcEtapa"));
		empresa.setMmcTexto(request.getParameter("mmcTexto"));
		...
		empresa.setNumAdherente(request.getParameter("numAdherente"));
		empresa.setNumCentrosTrabajo(request.getParameter("numCentrosTrabajo"));
		empresa.setNumCphs(request.getParameter("numCphs"));
		empresa.setNumCphsBronce(request.getParameter("numCphsBronce"));
		empresa.setNumCphsPlata(request.getParameter("numCphsPlata"));
		empresa.setNumCphsOro(request.getParameter("numCphsOro"));
		empresa.setNumCphsCertificado(request.getParameter("numCphsCertificado"));
		empresa.setOxido(request.getParameter("oxido"));
		empresa.setOxidoEtapa(request.getParameter("oxidoEtapa"));
		empresa.setOxidoTexto(request.getParameter("oxidoTexto"));
		empresa.setParticipacionMesaTrabajo(request.getParameter("participacionMesaTrabajo"));
		empresa.setPlaguicida(request.getParameter("plaguicida"));
		empresa.setPlaguicidaEtapa(request.getParameter("plaguicidaEtapa"));
		empresa.setPlaguicidaTexto(request.getParameter("plaguicidaTexto"));
		...
		empresa.setPlanesiEtapa(request.getParameter("planesiEtapa"));
		empresa.setPlanesiTexto(request.getParameter("planesiTexto"));
		empresa.setPrexor(request.getParameter("prexor"));
		empresa.setPrexorEtapa(request.getParameter("prexorEtapa"));
		empresa.setPrexorTexto(request.getParameter("prexorTexto"));
		empresa.setPsicosociales(request.getParameter("psicosociales"));
		empresa.setPsicosocialesEtapa(request.getParameter("psicosocialesEtapa"));
		empresa.setPsicosocialesTexto(request.getParameter("psicosocialesTexto"));
		empresa.setRadiaciones(request.getParameter("radiaciones"));
		empresa.setRadiacionesEtapa(request.getParameter("radiacionesEtapa"));
		empresa.setRadiacionesTexto(request.getParameter("radiacionesTexto"));
		empresa.setRadiacionUV(request.getParameter("radiacionUV"));
		empresa.setRadiacionUVEtapa(request.getParameter("radiacionUVEtapa"));
		empresa.setRadiacionUVTexto(request.getParameter("radiacionUVTexto"));
		...
		empresa.setSolventes(request.getParameter("solventes"));
		empresa.setSolventesEtapa(request.getParameter("solventeEtapa"));
		empresa.setSolventesTexto(request.getParameter("solventesTexto"));
		empresa.setTmert(request.getParameter("tmert"));
		empresa.setTmertEtapa(request.getParameter("tmertEtapa"));
		empresa.setTmertTexto(request.getParameter("tmertTexto"));
