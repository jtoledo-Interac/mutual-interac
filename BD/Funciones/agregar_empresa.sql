...
(
    ...
    IN xultima_visita_experto varchar,
    IN xultima_visita_director varchar,
    IN xultima_visita_gtte varchar,
    IN xultima_visita_alta_gerencia varchar,
    IN xreporte_visita varchar,
    IN xriesgo_de_fuga varchar,
    IN xreclamo_ultimo_periodo varchar,
